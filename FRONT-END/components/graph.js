...
export default function Graph() {
    const graphData = useSelector((state) => state.results);
    ...
    useEffect(() => {
        ...
        const runtimeCost = d3
            ...
            .curve(d3.curveCardinal);
        // setting the axes
        const xAxis = d3.axisBottom(xScale).tickFormat((i) => xData[i]);
    ...
    return (React.createElement("div", { className: "chartWrapper" },
        React.createElement("h2", { style: { marginTop: "10px" } }, "Line Charts "),
        React.createElement("svg", { className: "svgWrap", ref: svgRef, style: { display: "block", width: "800px", height: "600px", margin: '20px auto' } }),
        React.createElement("div", { style: { display: "flex", justifyContent: "center" } },
            React.createElement("div", { style: { marginRight: "10px" } },
                ...
                React.createElement("span", null, "Invocation Time")),
            React.createElement("div", null,
                ...
                React.createElement("span", null, "Runtime Cost")))));
}
;
